...
const WeeklySchedule = () => (
  <div className="absolute bottom-4 left-4 bg-black bg-opacity-75 p-2 sm:p-3 md:p-4 text-white rounded-lg w-52 sm:w-60 md:w-64">
    <h3 className="text-sm sm:text-lg md:text-lg font-bold text-center">Garage Timings</h3>
